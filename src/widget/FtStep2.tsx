...
export const FtStep2 = (props: any): JSX.Element => {
  ...
  const [selectTab, setSelectTab] = useState<string>(GearsStateTabs['0']);
  ...
  const tableHeads = (): JSX.Element => {
    return (
      <>
        <TableCell sx={{ fontSize: 13 }} style={{ maxWidth: '5px' }}>
          Gear #
        </TableCell>
        <TableCell sx={{ fontSize: 13 }} style={{ maxWidth: '5px' }}>
          Use QF
        ...
        <TableCell sx={{ fontSize: 13 }} style={{ maxWidth: '50px' }}>
          Filter Bandwidth
        </TableCell>
        <TableCell sx={{ fontSize: 13 }} style={{ maxWidth: '50px' }}>
          Cycles per Burst
        </TableCell>
        <TableCell sx={{ fontSize: 13 }} style={{ maxWidth: '60px' }}>
          Cycles per Additional Burst
        </TableCell>
        <TableCell sx={{ fontSize: 13 }} style={{ maxWidth: '50px' }}>
          Bursts per Cluster
        </TableCell>
        <TableCell sx={{ fontSize: 13 }} style={{ maxWidth: '70px' }}>
          Sensing Frequency(kHz)
        </TableCell>
        <TableCell sx={{ fontSize: 13 }} style={{ maxWidth: '40px' }}>
          QF Report Rate(Hz)
        </TableCell>
        <TableCell sx={{ fontSize: 13 }} style={{ maxWidth: '40px' }}>
          MF Report Rate(Hz)
          ...
          <TabPanel value={selectTabValue} index={idx} key={idx}>
            <div style={{ height: 300, width: '100%' }}>
              <TableContainer component={Paper}>
                <Table sx={{ maxWidth: 750 }} size="small">
                  <TableHead>
